...
import com.mdstudios.entities.BulletShoot;
import com.mdstudios.entities.Enemy;
	...
	public void render() {
		...
		if(gameState == "GAME_OVER") {
			...
			if(showMessageGameOver)
				g.drawString("> Precione ENTER para reiniciar <", (WIDTH * SCALE) / 2 - 150, (HEIGHT * SCALE) / 2 + 20);
		}
		bs.show();
	}
